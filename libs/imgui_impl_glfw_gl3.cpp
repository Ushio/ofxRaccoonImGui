...
void ImGui_ImplGlfw_MouseButtonCallback_GL3(GLFWwindow*, int button, int action, int /*mods*/)
{
    if (action == GLFW_PRESS && button >= 0 && button < 3)
        g_MouseJustPressed[button] = true;
}

void ImGui_ImplGlfw_ScrollCallback_GL3(GLFWwindow*, double xoffset, double yoffset)
{
    ImGuiIO& io = ImGui::GetIO();
...
void ImGui_ImplGlfw_KeyCallback_GL3(GLFWwindow*, int key, int, int action, int mods)
{
    ImGuiIO& io = ImGui::GetIO();
...
void ImGui_ImplGlfw_CharCallback_GL3(GLFWwindow*, unsigned int c)
{
    ImGuiIO& io = ImGui::GetIO();
    if (c > 0 && c < 0x10000)
...
{
    glfwSetMouseButtonCallback(window, ImGui_ImplGlfw_MouseButtonCallback_GL3);
    glfwSetScrollCallback(window, ImGui_ImplGlfw_ScrollCallback_GL3);
    glfwSetKeyCallback(window, ImGui_ImplGlfw_KeyCallback_GL3);
    glfwSetCharCallback(window, ImGui_ImplGlfw_CharCallback_GL3);
}
